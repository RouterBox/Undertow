...
- **Hooks** in `~/.Codex/settings.json` — UserPromptSubmit, SessionStart, PostToolUse, Stop, PostCompact.
...
- **TTS** via Codex-to-Speech (`python C:/github/Codex-to-Speech/scripts/claude_speak.py --voice Daniel`).
...
| `INSTALL.md` | Codex-guided installation |
...
Codex sessions narrate actions through Codex-to-Speech using the Daniel voice:

```bash
python C:/github/Codex-to-Speech/scripts/claude_speak.py --voice Daniel "message here"
```
